...
function actualizarEquipoPersonalizado() {
  const equipo = document.getElementById("equipo").value;
  const bloque = document.getElementById("bloqueEquipoPersonalizado");
  const input = document.getElementById("equipoPersonalizado");
...
function obtenerEquipoFinal() {
  ...
  return document.getElementById("equipoPersonalizado").value.trim();
}

function validarEquipoPersonalizado() {
  const equipoSeleccionado = document.getElementById("equipo").value;
  const equipoPersonalizado = document.getElementById("equipoPersonalizado").value.trim();

  if (equipoSeleccionado === "Otro" && !equipoPersonalizado) {
    alert("Si eliges 'Otro', debes escribir el nombre del equipo.");
    return false;
  }
...
function limpiarFormularioCamiseta() {
  ...
  document.getElementById("equipoPersonalizado").value = "";
  ...
  actualizarEquipoPersonalizado();
  actualizarCamposCondicionales();
  actualizarPreview();
}

function agregarAlCarrito() {
  if (!validarEquipoPersonalizado()) return;
...
function activarEventosFormulario() {
  ...
  document.getElementById("equipo").addEventListener("change", actualizarEquipoPersonalizado);
